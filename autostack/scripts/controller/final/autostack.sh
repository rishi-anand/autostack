...
if [ "$check" = true ] && [ "$controllerthree" -eq 58 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 59 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 60 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 61 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 62 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 63 ]; then
keystone endpoint-create \
...
if [ "$check" = true ] && [ "$controllerthree" -eq 64 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 65 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 66 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 67 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 68 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 69 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 70 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 71 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 72 ]; then
source admin-openrc.sh || check=false 
echo -------------------$filename line no : "$controllerthree"------------------------
#line no 72
((controllerthree=controllerthree+1))
...
if [ "$check" = true ] && [ "$controllerthree" -eq 73 ]; then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 74 ];then
...
if [ "$check" = true ] && [ "$controllerthree" -eq 75 ]; then
rm -r /tmp/images
echo -------------------$filename line no : "$controllerthree"------------------------
#line no 75
((controllerthree=controllerthree+1))
...
if [ "$check" = true ] && [ "$controllerfour" -eq 76 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 77 ]; then
source admin-openrc.sh || check=false 
echo -------------------$filename line no : "$controllerfour"------------------------
#line no 77
((controllerfour=controllerfour+1))
...
if [ "$check" = true ] && [ "$controllerfour" -eq 78 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 79 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 80 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 81 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 82 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 83 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 84 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 85 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 86 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 87 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 88 ]; then
echo ----------- VERIFYING  NOVA ------------------------------
source admin-openrc.sh || check=false
echo -------------------$filename line no : "$controllerfour"------------------------
#line no 88
...
if [ "$check" = true ] && [ "$controllerfour" -eq 89 ]; then
...
if [ "$check" = true ] && [ "$controllerfour" -eq 90 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 91 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 92 ]; then
source admin-openrc.sh || check=false 
echo ------------------"$filename" line no : "$controllerfifth"------------------------
#line no 92
((controllerfifth=controllerfifth+1))
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 93 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 94 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 95 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 96 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 97 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 98 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 99 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 100 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 101 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 102 ]; then
sudo service nova-api restart || check=false
sudo service nova-cert restart || check=false
sudo service nova-consoleauth restart || check=false
sudo service nova-scheduler restart || check=false
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 103 ]; then
source admin-openrc.sh || check=false
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 104 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 105 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 106 ]; then
echo -------- NOVA ON COMPUTE [GOING TO COMPUTE NODE] -----------
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 107 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 108 ]; then
...
if [ "$check" = true ] && [ "$controllerfifth" -eq 109 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 110 ]; then
source admin-openrc.sh || check=false 
...
if [ "$check" = true ] && [ "$controllersixth" -eq 111 ]; then
source admin-openrc.sh || check=false
...
if [ "$check" = true ] && [ "$controllersixth" -eq 112 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 113 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 114 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 115 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 116 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 117 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 118 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 119 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 120 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 121 ]; then
...
if [ "$check" = true ] && [ "$controllersixth" -eq 122 ]; then
...
if [ "$check" = true ] && [ "$controllerseventh" -eq 123 ]; then
...
if [ "$check" = true ] && [ "$controllerseventh" -eq 124 ]; then
...
if [ "$check" = true ] && [ "$controllerseventh" -eq 125 ]; then
